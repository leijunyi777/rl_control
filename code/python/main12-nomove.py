...
_MAIN11_PATH = Path(__file__).with_name("main11-nomove.py")
_MAIN11_SPEC = importlib.util.spec_from_file_location("main11_nomove_module", _MAIN11_PATH)
...
def draw_scene(ax_anim, ax_z, ax_gap, frame, frames, lane_width, sim_time, collision_radius, desired_gap, safe_gap, vehicle_l):
    _MAIN11.draw_scene(ax_anim, ax_z, ax_gap, frame, frames, lane_width, sim_time, collision_radius, desired_gap, safe_gap, vehicle_l)
...
def main():
    ...
    dynamics = _MAIN11.Main11NoMoveDynamics(veh1, veh2, veh3, desired_gap=DESIRED_GAP, gap_safe=GAP_SAFE)
