...
EXPORT_PATH = "main11_nomove_confidence_u.gif"
EXPORT_FPS = 20
...
def draw_scene(ax_anim, ax_z, ax_gap, frame, frames, lane_width, sim_time, collision_radius, desired_gap, safe_gap, vehicle_l):
    ...
    title = f"Time: {frame['time']:.2f}s | Main11 No-Control RBF-u Comparison"
    if frame["collided"]:
        title += " | COLLISION"
...
def main():
    ...
    veh3 = EgoVehicleOdeModel(id="Veh 3 (Ego Constant Speed)", x=20.0, y=lane_width * 0.5, v=15.0, L=vehicle_l, color="lightgreen")
