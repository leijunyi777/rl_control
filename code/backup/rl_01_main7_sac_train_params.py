...
from model_ode import Main7GapFollowingDynamics, get_veh12_gap
from model_ode import KinematicBicycleModel, EgoVehicleOdeModel, front_velocity
...
# 鍔ㄤ綔瀵瑰簲鐨勫弬鏁拌寖鍥达細action = [k_mu, k, eps]
...
class Main7SacMergeEnv:
    ...
    def _get_obs(self):
        ...
        # 瑙傛祴瀹氫箟涓?ego 鐩稿浜庡墠杞﹀拰鍚庤溅鐨勪綅缃€侀€熷害銆?
